...
<html>
    ...
    <header>
        ...
        <h5 text-align="center"><jsp:getProperty name="myBean" property="msg2"/> <jsp:getProperty name="myBean" property="aut"/></h5>
            <br><br><br>
    </header>
    <body>
        <h4 text-align="center"><jsp:getProperty name="myBean" property="weekDayMsg"/> <jsp:getProperty name="myBean" property="weekDay"/>.</h4>
